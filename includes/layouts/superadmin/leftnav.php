 <nav class="navbar-left bg-light navbar-light fixed-top border border-top-0 border-left-0 border-bottom-0">
        ...
        <div class="mt-2 leftnav-links">
            ...
            <a <?php if (stripos($_SERVER['REQUEST_URI'],'my-dashboard.php') !== false) {echo 'class="nav-link active"';} ?> class="nav-link" href="../superadmin/dashboard.php">
                <i class="fa fa-home mr-2"></i><span>Dashboard</span>
            </a>

            <a <?php if (stripos($_SERVER['REQUEST_URI'],'change-password.php') !== false) {echo 'class="nav-link active"';} ?> class="nav-link" href="../superadmin/accounts.php">
                <i class="fa fa-lock mr-2"></i><span>Accounts</span>
            </a>

            <a <?php if (stripos($_SERVER['REQUEST_URI'],'notifications.php') !== false) {echo 'class="nav-link active"';} ?> class="nav-link" href="../superadmin/notifications.php">
