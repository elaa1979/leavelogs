<header>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-top navbar-light fixed-top border border-top-0 border-left-0 border-right-0">
        ...
        <div class="mr-auto">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="btn btn-sm btn-light mt-1 mr-3 active text-uppercase" href="../employees/manage-employees.php">Employees</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-sm btn-light mt-1 mr-3 active text-uppercase" href="../leave/home.php">Leaves</a>
                </li>
                <li class="nav-item">
        ...
        <ul class="navbar-nav">
            <?php if ($current_session != null && $current_session->SuperAdmin) { ?>
                <li class="nav-item">
                    <a class="btn btn-sm btn-light mt-1 mr-3 active text-uppercase" href="../admin/dashboard.php">Admin</a>
                </li>
                <li class="nav-item">
