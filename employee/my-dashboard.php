...
<body>
            ...
            <div class="col-sm-12">
                <div class="card mb-3">
                    <div class="card-header bg-light">
                        <h5 class="card-title mb-0">Log In Hours Calendar</h5>
                    </div>
                    <div class="card-body">
                        <div id="calendar"></div>
                    </div>
    ...
    <!--REQUIRED POPPERS 
    <?php include'../includes/holidays-list.php'; ?>
    <?php include'../includes/clock-in-edit.php'; ?>    
    <?php include'../includes/clock-out-edit.php'; ?> 
    <?php include'../includes/recent-leave-application.php'; ?>
    <?php include'../includes/apply-leave.php'; ?>
