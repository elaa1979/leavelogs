...
<head>
    <title>Leave Log - Admin - Manage Departments</title>
    <meta charset="utf-8">
    ...
    <?php
    $rows = DepartmentDAL::GetByAccountId($current_session->AccountId);
            ...
            <div class="col-sm-12">
                <div class="card mb-3 mt-3 border-0">
                    ...
                    <div class="card-body mh-250 p-0">
                        <table id="departments" class="table table-bordered mb-0" style="width:100%">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Name</th>
