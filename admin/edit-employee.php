...
<html lang="en">
<head>
    <title>Leave Log - Edit Employee</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="content-section mb-0 pb-0">
        <div class="row">
            <div class="col-lg-12">
                <a href="employees.php" class="float-left mr-2"><i class="fa fa-chevron-circle-left text-muted text-24 lh-30"></i></a><h4>Edit Employee</h4>
            </div>
        </div>
    </div>
