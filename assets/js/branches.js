...
$(document).ready(function () {
    var table = $('#branches').DataTable({
        ...
        "pagingType": "simple",
        "order": [[3, "desc"]],
        "columnDefs": [{ "searchable": false,"orderable": false, "targets": [0, 1, 2, 6] }],
        "columns": [
            {
    ...
    $('#branches tbody').on('click', 'td.details-control', function () {
    ...
    $("#selectall").click(function () {
        ...
        var deleteFlag = 0;
        var countRow = $('#branches tbody tr').length;
        if (countRow == 1) {
            var singleRowCheck = $('#branches tbody tr')["0"].innerText;
