...
$(document).ready(function () {
    var table = $('#LeaveTyes').DataTable({
        ...
        "pagingType": "simple",
        "order": [[0, "desc"]],
        "columnDefs": [{ "searchable": false,"orderable": false, "targets": [0, 1, 2, 3, 4] }],
        "columns": [
            {
    ...
    $('#LeaveTyes tbody').on('click', 'td.details-control', function () {
    ...
    $("#selectall").click(function () {
        ...
        var deleteFlag = 0;
        var countRow = $('#LeaveTyes tbody tr').length;
        if (countRow == 1) {
            var singleRowCheck = $('#LeaveTyes tbody tr')["0"].innerText;
